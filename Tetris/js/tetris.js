class Game {
    ...
    static TIMEOUT_LOCK_PUT_NEXT_PIECE = 500;
    ...
    initDomElements() {
        ...
        this.$score = document.querySelector("#punts");
        this.$btnPause = document.querySelector("#Pausar");
        this.$btnResume = document.querySelector("#Iniciar");
        this.$btnRotate = document.querySelector("#Rotar");
        this.$btnDown = document.querySelector("#Baixar");
        this.$btnRight = document.querySelector("#Dreta");
        this.$btnLeft = document.querySelector("#Esquerra");
